    ...
    return (
        <div className='aboutme'>
            ...
            < div className="radial-skills">
               ...
               <Skill name={"MySQL"} x="0vw" y="-16.5vw" />
               <Skill name={"React JS"} x="-12vw" y="-7vw" />
               <Skill name={"Dart"} x="6vw" y="9vw" />
               <Skill name={"Python"} x="23vw" y="-14vw" />
               <Skill name={"NodeJS"} x="22vw" y="10vw" />
               <Skill name={"Git"} x="16vw" y="-2.5vw" />
               <Skill name={"LLD"} x="-15vw" y="14vw" />
            </div>
        </div>
    )
}
